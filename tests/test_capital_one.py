...
@pytest.fixture
def valid_capital_one_html() -> str:
...
@pytest.fixture
def html_with_missing_image() -> str:
    return os.path.join(SAMPLES_DIR, "corrupted/corrupted_capital_one_no_image.html")


def test_parse_capital_one_offers_valid(valid_capital_one_html: str) -> None:
...
def test_parse_capital_one_offers_extra_whitespace(html_with_whitespace: str) -> None:
...
def test_parse_capital_one_offers_duplicates(html_with_duplicates: str) -> None:
...
def test_parse_capital_one_offers_special_chars(html_with_special_chars: str) -> None:
...
def test_parse_capital_one_offers_missing_file(non_existent_file: str) -> None:
...
def test_parse_capital_one_offers_missing_offer(corrupted_no_offer: str) -> None:
...
def test_parse_capital_one_offers_missing_company(corrupted_no_company: str) -> None:
...
def test_parse_capital_one_offers_invalid_structure(corrupted_invalid: str) -> None:
...
def test_parse_capital_one_offers_malformed_html(malformed_html: str) -> None:
...
def test_parse_capital_one_offers_missing_image(html_with_missing_image: str) -> None:
...
def test_parse_capital_one_offers_saves_to_json(valid_capital_one_html: str, tmp_path: Path) -> None:
    ...
    offers = parse_capital_one_offers(html_path=valid_capital_one_html, save_to=str(output_file))
