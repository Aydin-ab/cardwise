...
def test_parse_chase_offers_valid(valid_chase_html: str) -> None:
...
def test_parse_chase_offers_extra_whitespace(html_with_whitespace: str) -> None:
...
def test_parse_chase_offers_duplicates(html_with_duplicates: str) -> None:
...
def test_parse_chase_offers_special_chars(html_with_special_chars: str) -> None:
...
def test_parse_chase_offers_missing_file(non_existent_file: str) -> None:
...
def test_parse_chase_offers_missing_offer(corrupted_no_offer: str) -> None:
...
def test_parse_chase_offers_missing_company(corrupted_no_company: str) -> None:
...
def test_parse_chase_offers_invalid_structure(corrupted_invalid: str) -> None:
...
def test_parse_chase_offers_malformed_html(malformed_html: str) -> None:
...
def test_parse_chase_offers_save_to(valid_chase_html: str, tmp_path: Path) -> None:
    """✅ Test saving parsed Chase offers to a JSON file."""
    tmp_file: Path = tmp_path / "test_chase_offers.json"

    # Call the function with the save_to parameter
    offers = parse_chase_offers(html_path=valid_chase_html, save_to=str(tmp_file))
